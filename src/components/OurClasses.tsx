...
const OurClasses = ({ setSelectedPage }: Props) => {
    return (
        <section
            id="ourClasses"
            className="bg-primary-300 py-10 pb-[30px] lg:py-[95px]">
            <Container>
                <motion.div
                    onViewportEnter={() =>
                    ...
                    <motion.div
                        ...
                        className="md:w-3/5">
                        <div>
                            <h2 className="font-bold text-2xl"> OUR CLASSES</h2>
                            <p className=" py-5">
            ...
            <div className="mt-10 h-[353px] w-full overflow-x-auto overflow-y-hidden">
                <ul className="w-[2800px] overscroll-none  whitespace-nowrap flex justify-between px-[20px]">
